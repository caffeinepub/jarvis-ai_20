...
export interface _SERVICE {
  ...
  'getAllUserPrefs' : ActorMethod<[], Array<UserPreferences>>,
  'getConversationHistory' : ActorMethod<[], Array<Message>>,
  'getOpenAIKey' : ActorMethod<[], string>,
  'getUserPrefs' : ActorMethod<[], UserPreferences>,
  'sendMessage' : ActorMethod<[string, [] | [string]], string>,
  'sendOpenAIRequest' : ActorMethod<[string], string>,
  'setOpenAIKey' : ActorMethod<[string], undefined>,
  'transform' : ActorMethod<[TransformationInput], TransformationOutput>,
  'updateUserPrefs' : ActorMethod<[string, string, number], undefined>,
}
